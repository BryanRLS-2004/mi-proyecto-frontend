...
const API_URL = 'https://mi-proyecto-backend-relaxtotal.onrender.com/promotions';
...
export const uploadPromotionImage = async (file) => {
    ...
    const res = await axios.post("https://mi-proyecto-backend-relaxtotal.onrender.com/upload/promotion-image", formData, {
