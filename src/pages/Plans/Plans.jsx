...
const mapFromBackendPromotions = (p) => {
  ...
  let imageUrl = p.imageUrl;
    if (imageUrl && !imageUrl.startsWith('http') && !imageUrl.startsWith('/assets')) {
      imageUrl = `https://mi-proyecto-backend-relaxtotal.onrender.com${imageUrl}`;
    }
...
const Plans = () => {
  ...
  useEffect(() => {
    const loadPlans = async () => {
      ...
      try {
        const res = await axios.get('https://mi-proyecto-backend-relaxtotal.onrender.com/plans');
  ...
  useEffect(() => {
    const loadPromotions = async () => {
      ...
      try {
        const res = await axios.get('https://mi-proyecto-backend-relaxtotal.onrender.com/promotions');
